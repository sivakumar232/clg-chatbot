...
def reranker_node(state: AgentState) -> AgentState:
    ...
    Reads:  candidate_chunks, rewritten_query, query
    ...
    with logfire.span(
        ...
        # Score top candidates down to top 5 precision chunks
        ...
        print("=" * 60)
        print(f"  RERANKER COMPLETE: {len(candidate_chunks)} -> Top {len(reranked)} in {elapsed:.2f}s")
        print("=" * 60)
